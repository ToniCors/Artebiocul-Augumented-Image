...
public class AugmentedImageNode extends AnchorNode {
  ...
  public void setImage(AugmentedImage image) {
    ...
    if (!ulCorner.isDone() || !urCorner.isDone() || !llCorner.isDone() || !lrCorner.isDone() || !main.isDone()) {
      CompletableFuture.allOf(ulCorner, urCorner, llCorner, lrCorner, main)
    ...
    cornerNode.setParent(this);
    cornerNode.setLocalPosition(localPosition);
    cornerNode.setRenderable(main.getNow(null));
